    ...
    <main>
        ...
        <section class="hero" id="hero">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="3000">
                            <div class="carousel-inner">
                            <div class="carousel-item">
                                    <img src="images/slider/image3.png" class="img-fluid" alt="">
                                </div>
                                <div class="carousel-item active">
                                    <img src="images/slider/image1.png" class="img-fluid" alt="" width="1000px">
                                </div>
                                <div class="carousel-item">
                                    <img src="images/slider/image5.png" class="img-fluid" alt="">
                                </div>
